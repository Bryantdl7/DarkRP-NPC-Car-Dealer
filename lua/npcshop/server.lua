...
function SpawnnpcShop()
		local shop = ents.Create("npc_shop")
			shop:SetPos( Vector(-2124.552979, -646.710999, -131.968750) ) --Don't forget spawn vectors here! That being said rp_downtown_v4c_v2 and v3 are good to go.
			shop:SetAngles( Angle(4.620006, -88.380402, 0.000000) )
			shop:Spawn()
			shop:DropToFloor()
end
